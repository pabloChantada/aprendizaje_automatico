...
@testset "Loss Vectors Length" begin
    ...
    trainingDataset = (rand(Float32, 2, 100), rand(Bool, 2, 100))
    # Test 3: Verificar mejora del modelo
@testset "Model Improvement" begin
    topology = [100, 10, 2]
    trainingDataset = (rand(Float32, 100, 2), rand(Bool, 100, 2))
    validationDataset = (rand(Float32, 100, 2), rand(Bool, 100, 2))
    testDataset = (rand(Float32, 100, 2), rand(Bool, 100, 2))
